...
public final class CodaBarWriter extends OneDimensionalCodeWriter {
  ...
  public boolean[] encode(String contents) {
    ...
    contents = contentsVerify(contents);
	int resultLength = resultLengthConstruct(contents);
	boolean[] result = new boolean[resultLength];
    int position = 0;
    for (int index = 0; index < contents.length(); index++) {
      int code = cConstruction(contents, index);
	boolean color = true;
      int counter = 0;
      int bit = 0;
...
private String contentsVerify(String contents) throws IllegalArgumentException {
...
private int resultLengthConstruct(String contents) throws IllegalArgumentException {
	int resultLength = 20;
...
private int cConstruction(String contents, int index) {
	char c = cConstruct(contents, index);
	int code = 0;
...
private char cConstruct(String contents, int index) {
